  ...
  return (
    <header className="sticky top-0 z-10 flex items-center justify-between p-4 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm shadow-sm h-20">
      <div className="flex items-center gap-3">
        <button onClick={onMenuClick} className="lg:hidden h-10 w-10 flex items-center justify-center rounded-full text-slate-600 dark:text-slate-300 bg-slate-200 dark:bg-slate-700 hover:bg-slate-300 dark:hover:bg-slate-600 transition-colors" aria-label="Open menu">
            <i className="fas fa-bars"></i>
        </button>
        <div className="text-2xl text-white p-2 rounded-lg bg-gradient-to-br from-indigo-500 to-purple-500 hidden sm:flex">
