...
const questions: Question[] = [
  {
    questionText: "HTML là viết tắt của cụm từ nào?",
    answers: [
    ...
    correctAnswer: 'A',
    explanation: "HTML là viết tắt của HyperText Markup Language (Ngôn ngữ Đánh dấu Siêu văn bản), đây là ngôn ngữ đánh dấu tiêu chuẩn để tạo ra các trang web."
  },
  {
    questionText: "Trong lập trình hướng đối tượng (OOP), khái niệm nào mô tả việc một đối tượng có thể có nhiều hình thái khác nhau?",
    answers: [
      { id: 'A', text: 'Tính kế thừa (Inheritance)' },
      { id: 'B', text: 'Tính đóng gói (Encapsulation)' },
      { id: 'C', text: 'Tính trừu tượng (Abstraction)' },
      { id: 'D', text: 'Tính đa hình (Polymorphism)' },
    ],
    correctAnswer: 'D',
    explanation: "Tính đa hình (Polymorphism) là một trong bốn trụ cột của OOP, cho phép các đối tượng của các lớp khác nhau phản ứng với cùng một thông điệp (lời gọi phương thức) theo những cách riêng."
  },
];
...
const ITQuiz: React.FC = () => {
  ...
  const handleNext = () => {
    if (currentQuestionIndex < questions.length - 1) {
      ...
      alert("Bạn đã hoàn thành bài kiểm tra Tin học!");
    }
  }
  ...
  return (
    <div className="max-w-3xl mx-auto bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-lg">
      <h2 className="text-3xl font-bold text-center mb-2">Bài kiểm tra Tin học</h2>
